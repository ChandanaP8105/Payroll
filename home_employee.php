        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="add_employee.php" name="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="emp_type" class="form-control" placeholder="Employee Type" required>
                      ...
                      <option value="Job Order">Intern</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="division" class="form-control" placeholder="Division" required>
                      ...
                      <option value="Engineering">Software Engineering-I</option>
					  <option value="Engineering">Software Engineering-II</option>
                    </select>
                  </div>
                </div>
