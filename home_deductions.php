...
<?php
  ...
  $conn = mysqli_connect("localhost", "root", "nabis@24", "payroll");
  if (!$conn)
  {
          ...
          <ul class="nav nav-justified">
            ...
            <li>
              ...
              <form class="form-horizontal" action="#" name="form">
                ...
                <div class="form-group">
                  <label class="col-sm-5 control-label">Professional Tax  :</label>
                  <div class="col-sm-4">
                    <?php echo $gsis; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">Employee State Insurance  :</label>
                  <div class="col-sm-4">
                    <?php echo $love; ?>.00
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="add_deductions.php" name="form" method="post">
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label">Professional Tax</label>
                  <div class="col-sm-8">
                    <input type="text" name="gsis" class="form-control" value="<?php echo $gsis; ?>" required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Employee State Insurance</label>
                  <div class="col-sm-8">
